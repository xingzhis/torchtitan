...
def compare_approaches(norm_eps, clamp_eps, z_dim):
    ...
    # 3. Cosine Similarity
    cossim = z_norm1 @ (z_norm2.transpose(1, 2))
...
if __name__ == "__main__":
    ...
    print("norm_eps: 1e-2, clamp_eps: 1e-2, z_dim: 10")
    compare_approaches(1e-2, 1e-2, 10)
    print("norm_eps: 1e-4, clamp_eps: 1e-4, z_dim: 10")
    compare_approaches(1e-4, 1e-4, 10)