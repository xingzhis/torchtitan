#!/usr/bin/env python
"""Verify FineWeb-Edu dataset integration."""

print("=" * 70)
print("Test 1: Check dataset is registered")
print("=" * 70)
from torchtitan.datasets.hf_datasets import DATASETS
print(f"✓ fineweb_edu registered: {'fineweb_edu' in DATASETS}")
print()
...
config = DATASETS['fineweb_edu']
ds = config.loader('./local_datasets/fineweb_edu_10B_shuffled')
sample = next(iter(ds))
...
ds = load_from_disk('./local_datasets/fineweb_edu_10B_shuffled')
